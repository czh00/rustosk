...
export const compactLayout: KeyDefinition[][] = [
  ...
  [
    ...
    { code: 0x51, label: 'q', sub: 'Q', zhPinyin: 'ㄆ', bl_ov: { display: '😊', value: '😊', isDirect: true } },
    { code: 0x57, label: 'w', sub: 'W', zhPinyin: 'ㄊ', bl_ov: { display: '😂', value: '😂', isDirect: true } },
    { code: 0x45, label: 'e', sub: 'E', zhPinyin: 'ㄍ', bl_ov: { display: '❤️', value: '❤️', isDirect: true } },
    { code: 0x52, label: 'r', sub: 'R', zhPinyin: 'ㄐ', bl_ov: { display: '👍', value: '👍', isDirect: true } },
    { code: 0x54, label: 't', sub: 'T', zhPinyin: 'ㄔ', bl_ov: { display: '🎉', value: '🎉', isDirect: true } },
    { code: 0x59, label: 'y', sub: 'Y', zhPinyin: 'ㄗ', bl_ov: { display: '🔥', value: '🔥', isDirect: true } },
    { code: 0x55, label: 'u', sub: 'U', zhPinyin: 'ㄧ', bl_ov: { display: '✨', value: '✨', isDirect: true } },
    { code: 0x49, label: 'i', sub: 'I', zhPinyin: 'ㄛ', bl_ov: { display: '🚀', value: '🚀', isDirect: true } },
    { code: 0x4F, label: 'o', sub: 'O', zhPinyin: 'ㄟ', bl_ov: { display: '🤔', value: '🤔', isDirect: true } },
    { code: 0x50, label: 'p', sub: 'P', zhPinyin: 'ㄣ', bl_ov: { display: '😅', value: '😅', isDirect: true } },
    { code: 0xDB, label: '[', sub: '{', zhPinyin: '「', bl_ov: { display: '😎', value: '😎', isDirect: true } },
    { code: 0xDD, label: ']', sub: '}', zhPinyin: '」', bl_ov: { display: '🙄', value: '🙄', isDirect: true } },
    { code: 0xDC, label: '\\', sub: '|', width: 1.5, bl_ov: { display: '😢', value: '😢', isDirect: true } }
  ],
  // ASDF row
  [
    { code: 0x14, label: '⇪', special: true, class: 'cyan-text', width: 1.75 },
    { code: 0x41, label: 'a', sub: 'A', zhPinyin: 'ㄇ', bl_ov: { display: '😡', value: '😡', isDirect: true } },
    { code: 0x53, label: 's', sub: 'S', zhPinyin: 'ㄋ', bl_ov: { display: '👏', value: '👏', isDirect: true } },
    { code: 0x44, label: 'd', sub: 'D', zhPinyin: 'ㄎ', bl_ov: { display: '🙌', value: '🙌', isDirect: true } },
    { code: 0x46, label: 'f', sub: 'F', zhPinyin: 'ㄑ', bl_ov: { display: '🎈', value: '🎈', isDirect: true } },
    { code: 0x47, label: 'g', sub: 'G', zhPinyin: 'ㄕ', bl_ov: { display: '🎁', value: '🎁', isDirect: true } },
    { code: 0x48, label: 'h', sub: 'H', zhPinyin: 'ㄘ', bl_ov: { display: '🍕', value: '🍕', isDirect: true } },
    { code: 0x4A, label: 'j', sub: 'J', zhPinyin: 'ㄨ', bl_ov: { display: '☕', value: '☕', isDirect: true } },
    { code: 0x4B, label: 'k', sub: 'K', zhPinyin: 'ㄜ', bl_ov: { display: '🌟', value: '🌟', isDirect: true } },
    { code: 0x4C, label: 'l', sub: 'L', zhPinyin: 'ㄠ', bl_ov: { display: '🌈', value: '🌈', isDirect: true } },
    { code: 0xBA, label: ';', sub: ':', zhPinyin: 'ㄤ', bl_ov: { display: '🍀', value: '🍀', isDirect: true } },
    { code: 0xDE, label: "'", sub: '"', zhPinyin: '、', bl_ov: { display: '🍎', value: '🍎', isDirect: true } },
    { code: 0x0D, label: '⏎', class: 'enter special', width: 2.25 }
  ],
  // ZXCV row
  [
    { code: 0xA0, label: '⇧', special: true, width: 2.5 },
    { code: 0x5A, label: 'z', sub: 'Z', zhPinyin: 'ㄈ', bl_ov: { display: '🐱', value: '🐱', isDirect: true } },
    { code: 0x58, label: 'x', sub: 'X', zhPinyin: 'ㄌ', bl_ov: { display: '🐶', value: '🐶', isDirect: true } },
    { code: 0x43, label: 'c', sub: 'C', zhPinyin: 'ㄏ', bl_ov: { display: '🦄', value: '🦄', isDirect: true } },
    { code: 0x56, label: 'v', sub: 'V', zhPinyin: 'ㄒ', bl_ov: { display: '🎮', value: '🎮', isDirect: true } },
    { code: 0x42, label: 'b', sub: 'B', zhPinyin: 'ㄖ', bl_ov: { display: '💻', value: '💻', isDirect: true } },
    { code: 0x4E, label: 'n', sub: 'N', zhPinyin: 'ㄙ', bl_ov: { display: '📱', value: '📱', isDirect: true } },
    { code: 0x4D, label: 'm', sub: 'M', zhPinyin: 'ㄩ', bl_ov: { display: '💪', value: '💪', isDirect: true } },
    { code: 0xBC, label: ',', sub: '<', zhPinyin: 'ㄝ', bl_ov: { display: '💯', value: '💯', isDirect: true } },
    { code: 0xBE, label: '.', sub: '>', zhPinyin: 'ㄡ', bl_ov: { display: '💡', value: '💡', isDirect: true } },
    { code: 0xBF, label: '/', sub: '?', zhPinyin: 'ㄥ', bl_ov: { display: '✅', value: '✅', isDirect: true } },
...
export const fullLayout: KeyDefinition[][] = [
  ...
  [
    ...
    { code: 0, label: '', special: true, class: 'invisible', width: 2/3 },
  ...
  [
    { code: 0xC0, label: '`', sub: '~' },
    { code: 0x31, label: '1', sub: '!', zhPinyin: 'ㄅ' }, { code: 0x32, label: '2', sub: '@', zhPinyin: 'ㄉ' }, { code: 0x33, label: '3', sub: '#', zhPinyin: 'ˇ' },
    { code: 0x34, label: '4', sub: '$', zhPinyin: 'ˋ' }, { code: 0x35, label: '5', sub: '%', zhPinyin: 'ㄓ' }, { code: 0x36, label: '6', sub: '^', zhPinyin: 'ˊ' },
    { code: 0x37, label: '7', sub: '&', zhPinyin: '˙' }, { code: 0x38, label: '8', sub: '*', zhPinyin: 'ㄚ' }, { code: 0x39, label: '9', sub: '(', zhPinyin: 'ㄞ' },
    { code: 0x30, label: '0', sub: ')', zhPinyin: 'ㄢ' }, { code: 0xBD, label: '-', sub: '_', zhPinyin: 'ㄦ' }, { code: 0xBB, label: '=', sub: '+' },
    ...
    { code: 0, label: '', special: true, class: 'invisible', width: 0.25 },
    { code: 0x90, label: 'Num', special: true }, { code: 0x6F, label: '/', special: true }, { code: 0x6A, label: '*', special: true }, { code: 0x6D, label: '-', special: true }
  ],
  ...
  [
    ...
    { code: 0x20, label: 'Space', class: 'space', width: 6.25 },
